    ...
    <Container fluid style={{backgroundColor: '#62A4F1', paddingBottom: '50px'}}>
      <Container >
        <Flex
          ...
          direction="row"
          wrap="wrap">
            <Title style={{ fontFamily: 'Lilita One, sans-serif', fontWeight: '400', fontSize: 'rem(80px)', lineHeight: '1.1', color: 'black'}}>BRAND YANG KAMI SEWAKAN</Title>
        </Flex>
    <Grid gutter="xl">
      {items.map((item) => (
        <Grid.Col key={item.id} span={4}>
          <Card withBorder radius="md" mt={20} className={classes.card}>
